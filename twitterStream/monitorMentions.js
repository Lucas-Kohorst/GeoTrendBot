    ...
    if (reply_to === "GeoTrendBot") {
        ...
        if (params.text.search("#") != -1) {
            ...
            twitter.trends().then(function(value) {
                ...
                var new_tweet = "@" + from + " I couldn't understand that reply with a valid hashtag. Here's a random map " + base_url + randomTrend;
                var tweet = {
                    status: new_tweet,
                    in_reply_to_status_id: nameID
                };
